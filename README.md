  ...
  <g transform="translate(0, 0) rotate(0)">
    <foreignObject x="10" y="10" width="960" height="850">
      <body xmlns="http://www.w3.org/1999/xhtml">
        <iframe src="https://chromestatus.com/metrics/feature/timeline/popularity/1689" style="width:600px;height:300px"  onload="setTimeout(()=>{document.body.style.background='lightgreen';this.contentWindow.document.documentElement.scrollTop=300},100)"></iframe>
      </body>
    </foreignObject>
  </g>
</svg>
